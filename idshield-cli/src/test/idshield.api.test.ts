...
import { type IdShieldProviders } from '../common-types';
...
describe('API', () => {
  ...
  let providers: IdShieldProviders;
  ...
  it('should deploy the contract[@slow]', async () => {
    const counterContract = await api.deploy(providers);
    // eslint-disable-next-line no-undef
    console.log(counterContract.deployTxData.public.contractAddress);
