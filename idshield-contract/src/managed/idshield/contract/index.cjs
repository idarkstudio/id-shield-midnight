...
class _ClinicalRecord_0 {
  ...
  fromValue(value_0) {
    return {
      genre: _descriptor_1.fromValue(value_0),
      fullName: _descriptor_2.fromValue(value_0),
      medicalCoverage: _descriptor_3.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.genre).concat(_descriptor_2.toValue(value_0.fullName).concat(_descriptor_3.toValue(value_0.medicalCoverage)));
  }
}

const _descriptor_4 = new _ClinicalRecord_0();
...
class _Consultation_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_5.alignment().concat(_descriptor_2.alignment().concat(_descriptor_6.alignment())));
  }
  fromValue(value_0) {
    return {
      professionalId: _descriptor_2.fromValue(value_0),
      date: _descriptor_5.fromValue(value_0),
      result: _descriptor_2.fromValue(value_0),
      specialistType: _descriptor_6.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.professionalId).concat(_descriptor_5.toValue(value_0.date).concat(_descriptor_2.toValue(value_0.result).concat(_descriptor_6.toValue(value_0.specialistType))));
  }
}

const _descriptor_7 = new _Consultation_0();
...
class _VehicleRecord_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_9.alignment().concat(_descriptor_5.alignment()));
  }
  fromValue(value_0) {
    return {
      insuranceStatus: _descriptor_8.fromValue(value_0),
      insuranceType: _descriptor_9.fromValue(value_0),
      insurancePaidDate: _descriptor_5.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.insuranceStatus).concat(_descriptor_9.toValue(value_0.insuranceType).concat(_descriptor_5.toValue(value_0.insurancePaidDate)));
  }
}

const _descriptor_10 = new _VehicleRecord_0();
...
class _Maybe_0 {
  ...
  toValue(value_0) {
    return _descriptor_11.toValue(value_0.is_some).concat(_descriptor_7.toValue(value_0.value));
  }
}
...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerVehicle: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('registerVehicle',
                                      ...
                                      'idshield.compact line 48 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_8.toValue(status_0).concat(_descriptor_9.toValue(insType_0).concat(_descriptor_5.toValue(paidDate_0))),
            alignment: _descriptor_8.alignment().concat(_descriptor_9.alignment().concat(_descriptor_5.alignment()))
          },
          output: undefined,
          publicTranscript: [],
      ...
      canDrive: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('canDrive',
                                      'argument 1 (as invoked from Typescript)',
                                      'idshield.compact line 61 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_5.toValue(currentTime_0),
      ...
      viewVehicle: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('viewVehicle',
                                      'argument 1 (as invoked from Typescript)',
                                      'idshield.compact line 70 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
      ...
      registerClinicalHistory: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`registerClinicalHistory: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('registerClinicalHistory',
                                      'argument 1 (as invoked from Typescript)',
                                      'idshield.compact line 77 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(genre_0).concat(_descriptor_2.toValue(fullName_0).concat(_descriptor_3.toValue(medicalCoverage_0))),
      ...
      addConsultation: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('addConsultation',
                                      'argument 1 (as invoked from Typescript)',
                                      'idshield.compact line 90 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(professionalId_0).concat(_descriptor_5.toValue(date_0).concat(_descriptor_2.toValue(result_1).concat(_descriptor_6.toValue(specialistType_0)))),
            alignment: _descriptor_2.alignment().concat(_descriptor_5.alignment().concat(_descriptor_2.alignment().concat(_descriptor_6.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      viewClinicalHistory: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('viewClinicalHistory',
                                      'argument 1 (as invoked from Typescript)',
                                      'idshield.compact line 106 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
  ...
  _secretKey_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.type_error('secretKey',
                                  'return value',
                                  'idshield.compact line 39 char 1',
                                  'Bytes<32>',
                                  result_0)
    }
  ...
  _canDrive_0(context, partialProofData, currentTime_0) {
    const pk_0 = this._publicKey_0(this._secretKey_0(context, partialProofData));
    const record_0 = _descriptor_10.fromValue(Contract._query(context,
                                                              partialProofData,
                                                              [
                                                               { dup: { n: 0 } },
                                                               { idx: { cached: false,
                    ...
                    [
                     ...
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newArray()
                                        .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(tmp_0),
    ...
    clinicalRegistry: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.type_error('member',
                                      'argument 1',
                                      'idshield.compact line 21 char 1',
                                      'Bytes<32>',
                                      key_0)
        }
        return _descriptor_11.fromValue(Contract._query(context,
                                                             ...
                                                             { push: { storage: false,
                                                                       value: __compactRuntime.StateValue.newCell(__compactRuntime.alignedConcat(
                                                                                                                    { value: _descriptor_15.toValue(0n),
                                                                                                                      alignment: _descriptor_15.alignment() },
                                                                                                                    { value: _descriptor_7.toValue({ professionalId: '', date: 0n, result: '', specialistType: 0 }),
